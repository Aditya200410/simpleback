...
// Complete comprehensive list of all GRC Services
const comprehensiveGRCServices = [
...
async function seedComprehensiveGRCServices() {
  try {
    ...
    const servicesWithUsers = comprehensiveGRCServices.map(service => ({
      ...service,
