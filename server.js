...
const grcCategoryRoutes = require('./routes/grcCategories');
const queryRoutes = require('./routes/queries');
const solutionCategoryRoutes = require('./routes/solutionCategories');
...
app.use('/api/grc-categories', grcCategoryRoutes);
